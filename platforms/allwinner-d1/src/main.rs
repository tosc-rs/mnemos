...
use d1_config::{PlatformConfig, Mapping, InterruptPin, LedBlinkPin};
use kernel::maitake::sync::WaitCell;
use mnemos_beepy::i2c_puppet::{I2cPuppetSettings, I2cPuppetServer, HsvColor, I2cPuppetClient};
use mnemos_d1::{
    ccu::Ccu,
    dmac::Dmac,
